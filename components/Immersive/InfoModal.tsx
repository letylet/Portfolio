    ...
    <>
        ...
        {objectData.contentType === 'MISSION' && (
            <div className="space-y-4">
                ...
                <p className="text-sm text-slate-700">{content.mission.solution}</p>
                </div>
                ...
                <p className="text-sm text-slate-700">{content.mission.resp}</p>
                </div>
                ...
                <p className="text-sm text-slate-700">{content.mission.results}</p>
                </div>
            </div>
        )}
    </>
