...
const ROOMS_DATA: Record<RoomId, InteractiveObjectData[]> = {
  ...
  IMMERSIVE: [
    { id: 'i1', imageUrl: getRoomElementImage("IMMERSIVE", "museum.png"), label: {it: 'Guida AR per Museo', en: 'Museum Guide in AR'}, x: 32, y: 49, contentType: 'MISSION', contentKey: 'museum', size: "40" },
  ...
  WEB: [
    ...
    { id: 'w2', imageUrl: getRoomElementImage("WEB", "laptop.png"), label: {it: 'Frontend Developer', en: 'Frontend Developer'}, x: 48, y: 50, contentType: 'TEXT', contentKey: 'laptop', size: "22" },
